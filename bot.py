...
follow_delay=random.randrange(50,100)
max_follows_per_day=random.randrange(100,150)
bot = Bot(max_follows_per_day=max_follows_per_day, follow_delay=follow_delay, filter_previously_followed=True, filter_verified_accounts=True, filter_private_users=True, filter_business_accounts=True)
# file_name="D:\insta-bot\password.txt"
